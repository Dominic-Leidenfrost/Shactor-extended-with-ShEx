...
class ShExFormatterTest {
    ...
    void disjunction_no_pipes() {
        String out = ShExFormatter.disjunction(java.util.List.of("@ex:AShape", "@ex:BShape"));
    ...
    void emitValueSet_basic() {
        String out = ShExFormatter.emitValueSet(java.util.List.of("xsd:string", "ex:Foo", "bar"));
